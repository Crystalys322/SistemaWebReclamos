...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    <div class="container-fluid">
        <a class="navbar-brand" href="<%= ctx %>/VistaUsuario.jsp">Reclamos</a>
        <div class="collapse navbar-collapse">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item"><a class="nav-link" href="<%= ctx %>/reclamos?accion=listar">Mis reclamos</a></li>
                <li class="nav-item"><a class="nav-link" href="<%= ctx %>/reclamos?accion=formulario">Registrar reclamo</a></li>
            </ul>
            <span class="navbar-text me-3">Hola, <%= nombreUsuario %></span>
        ...
        <div class="col-md-4">
            <div class="card border-success">
                <div class="card-body text-center">
                    ...
                    <a href="<%= ctx %>/reclamos?accion=listar" class="btn btn-success">Ver listado</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
